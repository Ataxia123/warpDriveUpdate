...
import { EncounterResultData, InterPlanetaryStatusReport, PilotData, PlanetData } from '~~/types/appTypes';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    const missions = db.collection('planets'); // Access to 'players' collection
